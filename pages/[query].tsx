        ...
        data => {
          if (data.done) {
            ...
            if (data.contemporaries.length === 0) {
              console.log("All contemporaries fetched");
              setAllFetched(true);
            }
          }
          else
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`Contemporaries of ${person.name}`} />
            ...
            >
              ...
              <Container maxW="container.xl">
                <Stack spacing="4ex">
                  ...
                  <Center pb="4ex">
                    {!!contemporaries && <LoadMoreButton fetching={!done} onLoadMore={onGetMore} disabled={allFetched} />}
                  </Center>
                </Stack>
              </Container>
            </Box>
